  ...
  return (
    <main>
      ...
      >
        ...
        {/* Navigation */}
        <nav className="relative z-10 flex items-center justify-between gap-6 max-w-6xl mx-auto w-full px-6 py-6" aria-label="Primary navigation">
        ...
        <div className="relative z-10 flex-1 flex items-center">
          <div className="max-w-6xl mx-auto px-6 w-full py-20">
            <p className="text-orange-300 text-sm font-black uppercase tracking-widest mb-4">Licensed general contractors</p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded bg-orange-500 hover:bg-orange-600 text-white font-black transition" href="/contact">
                Request a Quote
                <ArrowRight size={18} />
              </a>
              <a className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded border-2 border-white text-white hover:bg-white/10 font-black transition" href="#projects">
                View Projects
                <ArrowRight size={18} />
              </a>
            </div>
